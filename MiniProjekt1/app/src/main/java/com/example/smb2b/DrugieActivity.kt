...
class DrugieActivity : AppCompatActivity(), RecyclerViewAdapter.RowClickListener{
    ...
    lateinit var itemList: java.util.ArrayList<Item>
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        customAdapter = RecyclerViewAdapter(itemList, this)
    ...
    override fun onItemClickListener(nazwa: String, cena: String, ilosc: String){
        ...
        val nazwa1 = viewModel.tvProductO.setText(nazwa)
        ...
        db.collection("item_list")
            .addSnapshotListener { snapshot, e ->
                ...
                for (dc in snapshot!!.documentChanges) {
                    when (dc.type ) {
                       DocumentChange.Type.ADDED-> itemList.add(dc.document.toObject(Item::class.java))
                       DocumentChange.Type.MODIFIED->{
                           itemList.clear()
                           EventChangeListener()
                       }
                       DocumentChange.Type.REMOVED-> itemList.remove(dc.document.toObject(Item::class.java))
                    }
                }
